...
## Otimização do Modelo (Edge AI)

Após o treinamento, o modelo foi otimizado para execução em dispositivos com recursos limitados, como sistemas embarcados e IoT.
